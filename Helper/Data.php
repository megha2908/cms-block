...
*/
namespace LogicSpot\CmsBlock\Helper;
...
/**
 * Class Data
 * @package LogicSpot\CmsBlock\Helper
 */
class Data extends AbstractHelper
{
    ...
    {
        return strip_tags($this->_layout->createBlock('Magento\Cms\Block\Block')->setBlockId('logicspot_cms_block')->toHtml());
    }
} 